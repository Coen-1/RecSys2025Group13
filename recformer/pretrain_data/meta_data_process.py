...
META_ROOT = '/Users/coengiezen/Desktop/Amazon_dataset_recformer' # Set your meta data path
SEQ_ROOT = '/Users/coengiezen/Desktop/Amazon_dataset_recformer' # Set your seq data path
...
pretrain_meta_pathes = [f'{META_ROOT}/meta_{cate}.json' for cate in pretrain_categories]
pretrain_seq_pathes = [f'{SEQ_ROOT}/{cate}_5.json' for cate in pretrain_categories]
...
def extract_meta_data(path, meta_data, selected_asins):
    ...
    with open(path, 'r') as f:
        for line in tqdm(f, ncols=100):
            ...
            attr_dict['rev_sum'] = line['summary']
