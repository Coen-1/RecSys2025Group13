...
parser.add_argument(
    ...
    type=int,
    default=-1,       
    help='Terminate training after this many optimiser steps '
         '(steps *follow* gradient-accumulation). '
         'Leave at −1 to use num_train_epochs instead.',
)
...
def main():
    ...
    trainer = Trainer(accelerator="gpu",
                      max_steps=args.max_steps if args.max_steps > 0 else None,      # ← NEW
                    max_epochs=None if args.max_steps > 0 else args.num_train_epochs,
                     devices=args.device,
